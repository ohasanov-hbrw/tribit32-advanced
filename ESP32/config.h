...
#define RG_STORAGE_SDSPI_HOLD_CS
// Storage
...
#define RG_SCREEN_INIT()                                                                                           \
    ...
    ILI9341_CMD(0x36, 0xA8);          /* Memory Access Control  (0x20|0x80|0x08) */                       \
...
#define RG_GPIO_SDSPI_MOSI          GPIO_NUM_10
